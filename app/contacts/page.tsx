    ...
    <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-10 md:mb-12">
        ...
        <div className="card p-5 sm:p-6 md:p-8 text-center hover:scale-[1.02] sm:hover:scale-105 transition-transform duration-300">
          ...
          <a
            href="mailto:bkalyev79@gmail.com"
        ...
        <div className="card p-5 sm:p-6 md:p-8 text-center hover:scale-[1.02] sm:hover:scale-105 transition-transform duration-300">
          <div className="flex justify-center mb-3 sm:mb-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-green-100 rounded-full flex items-center justify-center">
              <WhatsAppIcon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-green-600" />
            </div>
          </div>
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">WhatsApp</h3>
          <a
            href="https://wa.me/996707490348"
            target="_blank"
            rel="noopener noreferrer"
            className="text-base sm:text-lg md:text-xl text-green-600 hover:text-green-700 font-semibold block break-all"
          >
            0707 490 348
          </a>
          <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Быстрая связь</p>
        </div>

        <div className="card p-5 sm:p-6 md:p-8 text-center hover:scale-[1.02] sm:hover:scale-105 transition-transform duration-300">
          <div className="flex justify-center mb-3 sm:mb-4">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-purple-100 via-pink-100 to-orange-100 rounded-full flex items-center justify-center">
              <InstagramIcon className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-pink-600" />
            </div>
          </div>
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Instagram</h3>
          <a
            href="https://www.instagram.com/ka1yevvv__/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-base sm:text-lg md:text-xl text-pink-600 hover:text-pink-700 font-semibold block break-all"
          >
            @ka1yevvv__
          </a>
          <p className="text-xs sm:text-sm text-gray-500 mt-1 sm:mt-2">Следите за новостями</p>
        </div>
      </div>
