  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        successMessage.className = 'fixed top-4 right-4 z-50 bg-green-50 border-2 border-green-200 rounded-xl p-4 shadow-lg animate-slide-up';
        successMessage.innerHTML = `
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold text-green-800">Заказ отправлен!</p>
              <p class="text-sm text-green-700">Мастер свяжется с вами в ближайшее время.</p>
            </div>
          </div>
        `;
      ...
      errorMessage.className = 'fixed top-4 right-4 z-50 bg-red-50 border-2 border-red-200 rounded-xl p-4 shadow-lg animate-slide-up';
      errorMessage.innerHTML = `
        <div class="flex items-start gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-red-700">${error.message || 'Ошибка при отправке заказа'}</p>
          </div>
        </div>
      `;
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="w-full btn-primary flex items-center justify-center gap-2 py-3 sm:py-4 text-base font-semibold"
      >
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-scale-in">
        <div
          className="bg-white rounded-2xl shadow-2xl border-2 border-gray-200 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-sm sm:text-base text-gray-600">
                  {serviceName} • {servicePrice.toLocaleString('ru-RU')} сом
                </p>
